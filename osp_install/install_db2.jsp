  ...
  <tr> 
    <td colspan="3"> <form action="install_db.jsp" method="post" name="form1" id="form1">
        <h1>
          ...
          Additional Database Features</h1>
        ...
        <blockquote>
          <blockquote> 
            <table width="100%" border="0" cellspacing="2" cellpadding="1">
              <tr> 
                <td><strong>Copyright Messages</strong></td>
                <td>&nbsp;</td>
              </tr>
              <tr> 
                <td valign="top">Allow user to select or enter<a href="helptext/db_schema.jsp" target="helpinright"></a></td>
                <td valign="top">&nbsp;</td>
              </tr>
              <tr> 
                <td valign="top">&nbsp;</td>
