...
<p>a.) Fill in the information on the creation page as shown in the image below. </p>
  <blockquote>
    <p>Tip: If other people are using the same server to do this tutorial, you may want to enter your initials for the 'Simulation Version', to help identify it as yours.</p>
    <p>Tip: Only the name and verision of the simulation are really required for entry. All information that you enter here (and pretty much anywhere else in the platform) can be edited later on. </p>
  <p><img src="images/tut_sim_auth_1_page2_createsim.PNG" alt="Create Simulation" width="607" height="278" border="1" /></p>
</blockquote>
  <p>b.) Hit the 'Create' button at the bottom of the form. You should then see the information has been stored, as shown below.</p>
  <blockquote>
    <p><img src="images/tut_sim_auth_1_page2_createsim_2.PNG" alt="Screen after creating simulation" width="541" height="262" border="1" /></p>
...
To report corrections or errors, please <a href="mailto:tech@opensimplatform.org?subject=Problem_on_tutorial_page_a1_page2">click here</a>. <br/>
(If the above link does not work, you can also just send an email to tech@opensimplatform.org with the subject heading 'Problem on Tutorial Page Simulation Authoring Page 2'.)
