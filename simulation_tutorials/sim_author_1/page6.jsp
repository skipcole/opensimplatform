...
<br />
<h1>Step 6. Enter your planned play ideas</h1>
<blockquote>
  <p>a.) Fill out the 'Planned Play Ideas' form as shown below.</p>
  <blockquote>
...
To report corrections or errors, please <a href="mailto:tech@opensimplatform.org?subject=Problem_on_tutorial_page_a1_page6">click here</a>. <br/>
(If the above link does not work, you can also just send an email to tech@opensimplatform.org with the subject heading 'Problem on Tutorial Page Simulation Authoring Page 6'.)
