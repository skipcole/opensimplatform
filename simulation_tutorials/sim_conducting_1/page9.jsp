...
<table  border="0" align="center" cellspacing="5">
  <tr>
    <td><div align="center"><!-- InstanceBeginEditable name="backButton" --><a href="page8.jsp">&lt;-- back </a><!-- InstanceEndEditable --></div></td>
    ...
    <td><div align="center"><!-- InstanceBeginEditable name="nextButton" --><a href="page10.jsp"> next --&gt;</a><!-- InstanceEndEditable --></div></td>
  </tr>
</table>
...
(If the above link does not work, you can also just send an email to tech@opensimplatform.org with the subject heading 'Problem on Tutorial Page'.)
