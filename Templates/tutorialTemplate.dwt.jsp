...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="80%" valign="middle"  background="../Templates/images/top_fade.png"><h2 class="header"><font color="#FFFFFF">&nbsp;USIP OSP Tutorial - <!-- TemplateBeginEditable name="tutorialName" -->tutorialName<!-- TemplateEndEditable --></font></h2></td>
...
<table  border="0" align="center" cellspacing="5">
  <tr>
    <td><div align="center"><!-- TemplateBeginEditable name="backButton" -->&lt;-- back <!-- TemplateEndEditable --></div></td>
    <td><div align="center"><!-- TemplateBeginEditable name="tocLink" -->table of contents<!-- TemplateEndEditable --></div></td>
    <td><div align="center"><!-- TemplateBeginEditable name="nextButton" --> next --&gt;<!-- TemplateEndEditable --></div></td>
  </tr>
</table>
<p>&nbsp;</p>
