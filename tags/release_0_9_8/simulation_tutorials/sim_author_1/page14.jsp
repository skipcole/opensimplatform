...
<blockquote>
  ...
  <p>d..) Hit the 'Save and Proceed' button to move on to the next  step.</p>
  <p>&nbsp;</p>
</blockquote>
<!-- InstanceEndEditable -->
<table  border="0" align="center" cellspacing="5">
  <tr>
    <td><div align="center"><!-- InstanceBeginEditable name="backButton" --><a href="page13.jsp">&lt;-- back </a><!-- InstanceEndEditable --></div></td>
    ...
    <td><div align="center"><!-- InstanceBeginEditable name="nextButton" --><a href="page15.jsp"> next --&gt;</a><!-- InstanceEndEditable --></div></td>
  </tr>
</table>
<!-- InstanceBeginEditable name="errorReporting" -->

To report corrections or errors, please <a href="mailto:tech@opensimplatform.org?subject=Problem_on_tutorial_page_a1_page14">click here</a>. <br/>
(If the above link does not work, you can also just send an email to tech@opensimplatform.org with the subject heading 'Problem on Tutorial Page Simulation Authoring Page 14'.)
