...
public class USIP_OSP_ContextListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		// SC - 9/20/2011.
		// I don't think we need this, and moving to a 'schema based cache'
		// makes it more
		// difficult and error prone to enable.
		// ServletContext context = sce.getServletContext();
		// USIP_OSP_ContextListener.resetWebCache(context);

		// Running into problem hitting the database before tomcat has restarted
		// completely
		// since the logout page leads automatically back to the login page.
