...
public class PSO_SectionMgmt {
	...
	/**
	 * Goes through the process of setting up a student chat room.
	 * 
	 * @param request
	 * @return
	 */
	public Conversation handleMakeStudentChatRoomPage(HttpServletRequest request) {
		...
		conv = Conversation.getStudentChatForSim(afso.schema, afso.sim_id, null);
		String save_and_add_to_this_actor = request.getParameter("save_and_add_to_this_actor");
