...
public class RunningSimSetAssignment {
	...
	public RunningSimSetAssignment(){
	 ...
	 * @param rs_set_id
	 */
	public RunningSimSetAssignment(String schema, Long rs_id, Long rs_set_id){
	 ...
	 * @return
	 */
	public static List <RunningSimSetAssignment> getAllForRunningSimulationSet(String schema, Long rs_set_id){
