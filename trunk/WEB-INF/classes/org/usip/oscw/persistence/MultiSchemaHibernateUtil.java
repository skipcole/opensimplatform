...
public class MultiSchemaHibernateUtil {
    ...
    public static void addRootSchemaClasses(AnnotationConfiguration ac) {
        ac.addAnnotatedClass(org.usip.oscw.persistence.BaseUser.class);
        ac.addAnnotatedClass(org.usip.oscw.persistence.SchemaInformationObject.class);
        ac.addAnnotatedClass(org.usip.oscw.persistence.UserRegistrationInvite.class);
        ac.addAnnotatedClass(org.usip.oscw.persistence.UserSchemaAssignment.class);
        ac.addAnnotatedClass(org.usip.oscw.persistence.USA_CompoundKey.class);
    }
	...
	public static void addSchemaClasses(AnnotationConfiguration ac) {
		// BaseObjects
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.Actor.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.BaseSimSection.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.CustomizeableSection.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.CustomLibrarySection.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.Debug.class);
		ac.addAnnotatedClass(org.usip.oscw.communications.Alert.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.RunningSimulation.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.Simulation.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.SimulationPhase.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.SimulationSection.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.User.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.UserAssignment.class);
		ac.addAnnotatedClass(org.usip.oscw.baseobjects.UserTrail.class);
		
		// Communications
		ac.addAnnotatedClass(org.usip.oscw.communications.ChatLine.class);
		ac.addAnnotatedClass(org.usip.oscw.communications.ConvActorAssignment.class);
		ac.addAnnotatedClass(org.usip.oscw.communications.Conversation.class);
		ac.addAnnotatedClass(org.usip.oscw.communications.Inject.class);
		ac.addAnnotatedClass(org.usip.oscw.communications.InjectGroup.class);
		ac.addAnnotatedClass(org.usip.oscw.communications.SharedDocument.class);
		
		// Special Features
		ac.addAnnotatedClass(org.usip.oscw.specialfeatures.PlayerReflection.class);
		ac.addAnnotatedClass(org.usip.oscw.specialfeatures.SimVariable.class);
		ac.addAnnotatedClass(org.usip.oscw.specialfeatures.IntVariable.class);
		ac.addAnnotatedClass(org.usip.oscw.specialfeatures.IntVariableHistory.class);
