    ...
    <td>
      ...
      <form action="create_user.jsp" method="post" name="form1" id="form1">
        <table width="80%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><strong>username/email<a href="../simulation_user_admin/helptext/user_email.jsp" target="helpinright"> (?):</a></strong></td>
              <td><input name="email" type="text" tabindex="1" value="<%= userOnScratchPad.getBu_username() %>" size="60"  /></td>
            </tr>
          <tr>
            <td height="29"><strong>temporary password<a href="../simulation_user_admin/helptext/temp_password.jsp" target="helpinright"> (?):</a></strong></td>
              <td><input name="password" type="text" tabindex="2" size="20" /></td>
            </tr>
			
          <tr>
            <td><strong>First Name <a href="../simulation_user_admin/helptext/first_name.jsp" target="helpinright">(?)</a>:</strong></td>
      <td>
        <label>
          ...
          <tr>
            <td><strong>Middle Name<a href="../simulation_user_admin/helptext/middle_name.jsp" target="helpinright"> (?)</a>:</strong></td>
      <td>
        <label>
          ...
          <tr>
            <td><strong>Last Name <a href="../simulation_user_admin/helptext/last_name.jsp" target="helpinright">(?)</a>:</strong></td>
      <td>
        <label>
