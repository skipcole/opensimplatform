          ...
          <td><table border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              <tr>
                ...
                <td width="100%"><h1> <br />
                  ...
                  <blockquote>
                    <p>On this page you can automatically set up many running simulations instantly. One will be created and enabled for each  for each user (beta tester) that you enter. Each user will be added to the simulation created for them as every actor in that simulation. </p>
                    <p><%= launchResults %><br />
                    </p>
