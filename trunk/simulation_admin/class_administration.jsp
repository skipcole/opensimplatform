        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              <tr>
                ...
                <td width="100%"><br />
                  <h1>Class Admininstration</h1>
                  <p>Tasks in this section help you to increase the functionality of your USIP OSP installation.</p>
                  <br />
                  <table width="100%" border="1" cellspacing="2" cellpadding="1">
                    <tr valign="top">
                      <td width="24%"><a href="class_creation.jsp">Create Class</a></td>
                      <td width="72%">Allows you add a new organization to this platform.</td>
                    </tr>
                    <tr valign="top">
                      <td><a href="class_review.jsp">Review Classes</a></td>
                      <td>Allows you see the classes defined on this platform and see who the instructors and students are.</td>
                    </tr>
                  </table>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p></td>
