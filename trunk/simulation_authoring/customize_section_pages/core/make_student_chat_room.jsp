...
<tr> 
    <td>
		...
		<tr>
			...
			<td width="100%"><br />
              <h1>Make Student Chat Room</h1>
              <br />
      <blockquote> 
	  <form action="make_student_chat_room.jsp" method="post" name="form2" id="form2">
	    <blockquote><strong>Tab Heading</strong>: 
	      <input type="text" name="tab_heading" value="<%= afso.getMyPSO_SectionMgmt().get_tab_heading() %>"/>
	     
          <p><strong>Title that will appear in this room:</strong><input type="text" name="page_title" id="page_title" value="<%= cs.getPageTitle() %>" />
          </p>
