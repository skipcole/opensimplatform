		...
		for (ListIterator li = allowableResponses.listIterator(); li.hasNext();) {
			...
			%>
              <tr>
                ...
                <td width="5%" valign="top"><a href="../../delete_object.jsp?object_type=allowable_response&amp;objid=<%= ar.getId() %>&amp;object_info="Answer <%= ar.getIndex() %>"><img src="../../images/delete.png" alt="Delete Answer" width="26" height="22" border="0" /></a></td>
              </tr>
