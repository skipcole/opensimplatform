...
<% 
	...
	SetOfLinksCustomizer solc = new SetOfLinksCustomizer(request, afso, cs);	
...
<tr> 
    <td>
		...
		<tr>
			...
			<td width="100%"><br />
              <h1>Customize Set of Links Page</h1>
              <br />
      <form action="make_setoflinks_page.jsp" method="post" name="form2" id="form2">
        <% if (cs.getId() != null) {
	   %>
