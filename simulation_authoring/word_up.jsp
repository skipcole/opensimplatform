...
<%
	String sample_data = (String) request.getParameter("sample_data");
%>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="80%" valign="top"><!-- InstanceBeginEditable name="pageTitle" -->Title<!-- InstanceEndEditable --></td>
...
<tr> 
	...
	<%= sample_data %>
      <p align="center"> 
	  <form name="form1" id="form1" method="post" action="word_up.jsp">
        <div align="center">
          <textarea id="textarea2" name="sample_data" style="height: 200px; width: 710px;">words</textarea></p> 
