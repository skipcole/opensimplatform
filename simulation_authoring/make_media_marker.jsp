...
<tr> 
    <td>
		...
		<tr>
			...
			<td width="100%"><br />
              <h1>Create Media Marker</h1>
              <br />
    <p>Large media items, such as videos, are not packaged along with a simulation, but instead stored in a directory on the server. When transporting a simulation it is necessary to transport them independently. To ensure that they are always transferred, one should create a marker for them here. <form action="make_media_marker.jsp" method="post" name="form2" id="form2">
