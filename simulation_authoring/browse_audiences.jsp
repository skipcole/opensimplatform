...
<tr> 
    <td>
		...
		<tr>
			...
			<td width="100%"><br />
              <h1>Browse Simulation Audiences </h1>
              <br />
      ...
      <blockquote>
		...
		%>
            ...
            <tr>
              <td width="15%">&nbsp;</td>
              <td width="85%"><%= sim.getAudience() %></td>
            </tr>
            <%
	}
%>
      ...
      <p align="left"><a href="create_simulation_audience.jsp">Back to Create/Edit Simulation Audience </a></p>
      <p align="left">&nbsp;</p></td>
		</tr>
		</table>	</td>
  </tr>
