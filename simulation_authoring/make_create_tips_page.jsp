...
<tr> 
    ...
    <form action="make_create_document_page.jsp" method="post" name="form2" id="form2">
      ...
      <h2>Create New Document</h2>
            <table>
              <tr>
                <td valign="top">Shared Tip Name <a href="helptext/document_display_title_help.jsp" target="helpinright">(?)</a>:</td>
      ...
      <p>&nbsp;</p>
      <p>Below are listed all of the shared tips currently associated with this simulation. </p>
