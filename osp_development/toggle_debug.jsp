<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,java.util.*,org.usip.osp.baseobjects.*" errorPage="../error.jsp" %>
<%
...
<tr> 
	...
	%>
      ...
      </blockquote>      <p align="center"><a href="../simulation_admin/software_development_section.jsp">Back to Simulation 
        Software Administration</a></p>			</td>
		</tr>
		</table>	</td>
  </tr>
  <tr> 
